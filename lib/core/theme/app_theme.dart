...
abstract class AppColors {
  ...
  static const Color slateBlue = Color(0xFF1E2128);    // dark charcoal (secondary swatch)
  static const Color gold = Color(0xFFD9A441);         // bright gold (book/sparkle gradient)
